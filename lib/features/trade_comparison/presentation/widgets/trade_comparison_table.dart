...
class TradeComparisonTable extends StatelessWidget {
  ...
  const TradeComparisonTable({super.key, required this.data});

  @override
  Widget build(BuildContext context) {
    return ViewDataTable<TradeComparisonEntity>(
      columns: const [
        ...
        ViewTableColumn(id: 'execution_d_t', label: 'EXECUTION D/T', width: 180),
  ...
  Widget _buildCell(BuildContext context, TradeComparisonEntity item, ViewTableColumn col) {
    ...
    switch (col.id) {
      ...
      case 'symbol':
        ...
        break;
      case 'order_d_t': text = item.orderDateTime; break;
      case 'b_s':
        text = item.buySell;
      ...
      case 'execution_d_t': text = item.executionDateTime; break;
