      ...
      builder: (ctx, resolvedCityByIp) {
        return ViewDataTable<BulkOrderDetailsEntity>(
          ...
          cellBuilder: (item, col) =>
              _buildBulkDetailCell(ctx, item, col, resolvedCityByIp),
        );
      },
    );
  }

  Widget _buildBulkDetailCell(
    BuildContext context,
    BulkOrderDetailsEntity item,
    ViewTableColumn col,
    ...
    switch (col.id) {
      ...
      case 'pl':
        ...
        textColor = item.pl >= 0 ? AppColors.primaryBlue : AppColors.errorColor;
        break;
      case 'tPrice':
